 ...
 */
public abstract class IndexableObjectServiceImpl<T extends IndexableObject> implements IndexableObjectService<T> {

    private static final Logger log = LogManager.getLogger(IndexableObjectServiceImpl.class);
    ...
    public SolrInputDocument buildDocument(Context context, T indexableObject) throws SQLException, IOException {
        ...
        doc.addField(SearchUtils.LAST_INDEXED_FIELD, new Date());
     ...
     */
    public void writeDocument(SolrInputDocument doc, FullTextContentStreams streams)
