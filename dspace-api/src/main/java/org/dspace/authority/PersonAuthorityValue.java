...
public class PersonAuthorityValue extends AuthorityValue {
    ...
    public String getId() {
        ...
        if(StringUtils.isNotBlank(firstName)) {
            nonDigestedIdentifier = PersonAuthorityValue.class.toString() + "field: " + getCategory() + "lastName: " + lastName + ", firstName: " + firstName;
        }
        else {
            nonDigestedIdentifier = PersonAuthorityValue.class.toString() + "field: " + getCategory() + "lastName: " + lastName ;
        }
